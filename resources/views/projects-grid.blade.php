                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-2">
                                            <h5 class="font-size-15 mb-1 text-truncate"><a href="projects-overview" class="text-reset">Dashboard UI</a></h5>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-2">
                                            <h5 class="font-size-15 mb-1 text-truncate"><a href="projects-overview" class="text-reset">Ecommerce App</a></h5>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-2">
                                            <h5 class="font-size-15 mb-1 text-truncate"><a href="projects-overview" class="text-reset">Calendar App</a></h5>
                                        ...
                                        <div class="pt-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge bg-success-subtle text-success font-size-12"><i class="mdi mdi-clock-outline font-size-14 me-1 align-middle"></i> 4 days left</span>
                                                <div class="avatar-group-item">
                                                    <a href="javascript: void(0);" class="d-block" data-bs-toggle="tooltip" data-bs-placement="top" title="Ronald Hatfield">
                                                        <img src="{{URL::asset('assets/images/users/avatar-5.jpg')}}" alt="" class="rounded-circle avatar-sm">
                                                    </a>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-2">
                                            <h5 class="font-size-15 mb-1 text-truncate"><a href="projects-overview" class="text-reset">Kanban Board</a></h5>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-2">
                                            <h5 class="font-size-15 mb-1 text-truncate"><a href="projects-overview" class="text-reset">Authentication</a></h5>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-2">
                                            <h5 class="font-size-15 mb-1 text-truncate"><a href="projects-overview" class="text-reset">Redesign - Landing Page</a></h5>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-2">
                                            <h5 class="font-size-15 mb-1 text-truncate"><a href="projects-overview" class="text-reset">Brand Logo Design</a></h5>
                                        ...
                                        <div class="pt-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="badge bg-success-subtle text-success font-size-12"><i class="mdi mdi-clock-outline font-size-14 me-1 align-middle"></i> 1 days left</span>
                                                <div class="avatar-group align-items-center">
                                                    <div class="avatar-group-item">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card">
                                    <div class="card-body pb-3">
                                        ...
                                        <div class="pt-2">
                                            <h5 class="font-size-15 mb-1 text-truncate"><a href="projects-overview" class="text-reset">Chat App</a></h5>
