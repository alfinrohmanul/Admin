        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-light rounded-3 text-center overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-primary-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-light text-center rounded-3 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-success-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-light text-center rounded-3 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-purple-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-light text-center rounded-3 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-warning-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-light text-center rounded-3 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-danger-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-light text-center rounded-3 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-info-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-light text-center rounded-3 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-secondary-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
        ...
        <div class="card">
            <div class="card-body">
                <div class="bg-light text-center rounded-3 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-dark-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
                    ...
                    <div class="py-3">
                        <h5 class="font-size-16 text-reset">Dark</h5>
                        <p class="mb-0 text-reset">Hex : #343a40</p>
                        <p class="mb-0 text-reset">RGB : rgb(52, 58, 64)</p>
                    </div>
                </div>
            </div><!-- end card body -->
        </div><!-- end card -->
        ...
        <div class="card">
            <div class="card-body">
                <div class="bglight text-center rounded-3 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-xl-6">
                            <div class="bg-light-subtle" style="height: 90px;"></div>
                        </div>
                        <div class="col-xl-6">
                    ...
                    <div class="py-3">
                        <h5 class="font-size-16 text-reset">Light</h5>
                        <p class="mb-0 text-reset">Hex : #f5f6f8</p>
                        <p class="mb-0 text-reset">RGB : rgb(116, 120, 141)</p>
                    </div>
                </div>
            </div><!-- end card body -->
        </div><!-- end card -->
