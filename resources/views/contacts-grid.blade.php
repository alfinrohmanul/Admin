                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-15 mb-1 text-truncate"><a href="pages-profile" class="text-reset">Jody
                                                Tondreau</a></h5>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-15 mb-1 text-truncate"><a href="pages-profile" class="text-reset">Dennis
                                                Goulet</a></h5>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h5 class="font-size-15 mb-1 text-truncate"><a href="#" class="text-reset">Cecelia Farrell</a></h5>
                                        <span class="badge bg-success-subtle text-success mb-0">Angular Developer</span>
                                    </div>
                                    <div class="flex-shrink-0 dropdown">
                                        <a class="text-body dropdown-toggle font-size-16" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true">
                                            <i class="icon-xs" data-feather="more-horizontal"></i>
