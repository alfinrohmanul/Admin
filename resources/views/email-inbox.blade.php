                ...
                <div class="py-3">
                    <div class="message-list mb-0 p-1">
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    ...
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Whitney Peter</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> Delectus, ut aut reiciendis – <span class="teaser text-muted fw-normal">Trip home from Colombo has been arranged, then Jenna will come get me from Stockholm. :)</span>
                                </a>
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    ...
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">me, Susanna</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"><span class="bg-warning badge me-2">Freelance</span> Wolombo has been arranged, – <span class="teaser text-muted fw-normal">Alright thanks. I'll have to re-book that somehow, i'll get back to you.</span>
                                </a>
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    ...
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Web Support</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> Re: New mail settings – <span class="teaser text-muted fw-normal">Will you answer him asap?</span>
                                </a>
                    ...
                    <div class="message-list mb-0 p-1 unread">
                        <div class="list">
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> <span class="bg-info badge me-2">Support</span> Off on Thursday - <span class="teaser text-muted fw-normal">Eff that place, you might as well stay here with us instead! Sent from my iPhone 4 4 mar 2014 at 5:55 pm</span>
                                </a>
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    ...
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Death to Stock</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> <span class="bg-primary badge me-2">Social</span> This Week's Top Stories – <span class="teaser text-muted fw-normal">Our top pick for you on Medium this week The Man Who Destroyed America’s Ego</span>
                                </a>
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    <img src="{{URL::asset('assets/images/users/avatar-1.jpg')}}" class="avatar-sm rounded-circle" alt="">
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Andrew Zimmer</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> Mochila Beta: Subscription Confirmed – <span class="teaser text-muted fw-normal">You've been confirmed! Welcome to the ruling class of the inbox. For your records, here is a copy of the information you submitted to us...</span>
                                </a>
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    <img src="{{URL::asset('assets/images/users/avatar-2.jpg')}}" class="avatar-sm rounded-circle" alt="">
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Randy, me (5)</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"><span class="bg-success badge me-2">Family</span> Weekend on Revibe – <span class="teaser text-muted fw-normal">Today's Friday and we thought maybe you want some music inspiration for the weekend. Here are some trending tracks and playlists we think you should give a listen!</span>
                                </a>
                                <div class="date"><i class="mdi mdi-link-variant me-2 font-size-15 align-middle"></i> 4:24 PM</div>
                            </div>
                        </div>
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    ...
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">KanbanFlow</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> Task assigned: Clone ARP's website
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    ...
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Revibe</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> Last pic over my village – <span class="teaser text-muted fw-normal">Yeah i'd like that! Do you remember the video you showed me of your train ride between Colombo and Kandy? The one with the mountain view? I would love to see that one again!</span>
                                </a>
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    <img src="{{URL::asset('assets/images/users/avatar-1.jpg')}}" class="avatar-sm rounded-circle" alt="">
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Erik, me (5)</a></h5>
                                        <a href="" class="text-muted text-uppercase font-size-12">07 Threads</a>
                                    </div>
                                </div>
                                <span class="star-toggle far fa-star"></span>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> <span class="bg-danger badge me-2">Friends</span> Let's go fishing! – <span class="teaser text-muted fw-normal">Hey, You wanna join me and Fred at the lake tomorrow? It'll be awesome.</span>
                                </a>
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    <img src="{{URL::asset('assets/images/users/avatar-1.jpg')}}" class="avatar-sm rounded-circle" alt="">
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Stack Exchange</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> 1 new items in your Stackexchange inbox
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    <img src="{{URL::asset('assets/images/users/avatar-7.jpg')}}" class="avatar-sm rounded-circle" alt="">
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">Google Drive Team</a></h5>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> You can now use your storage in Google
                        ...
                        <div class="list">
                            <div class="col-mail col-mail-1">
                                ...
                                <div class="d-flex title align-items-center">
                                    <img src="{{URL::asset('assets/images/users/avatar-4.jpg')}}" class="avatar-sm rounded-circle" alt="">
                                    <div class="flex-1 ms-2 ps-1">
                                        <h5 class="font-size-14 mb-0"><a href="" class="text-reset">me, Peter (5)</a></h5>
                                        <a href="" class="text-muted text-uppercase font-size-12">07 Threads</a>
                                    </div>
                                </div>
                                <span class="star-toggle far fa-star"></span>
                            ...
                            <div class="col-mail col-mail-2">
                                <a href="#" class="subject text-reset"> <span class="bg-info badge me-2">Support</span> Home again! – <span class="teaser text-muted fw-normal">That's just perfect! See you tomorrow.</span>
                                </a>
