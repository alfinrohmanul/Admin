                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <blockquote class="blockquote custom-blockpuote blockpuote-primary rounded mb-0">
                            <p class="font-size-14 text-reset mb-2">At vero eos et accusamus dignissimos ducimus blanditiis.</p>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <blockquote class="blockquote custom-blockpuote blockpuote-light rounded mb-0">
                            <p class="font-size-14 text-reset mb-2">At vero eos et accusamus dignissimos ducimus blanditiis.</p>
                            <footer class="blockquote-footer text-reset font-size-13 mt-2"> Angie Burt <cite title="Source Title">Designer</cite></footer>
                        </blockquote>
                    </div>
                </div>
            </div><!-- end col -->
