    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                ...
                <div id="chart-donut" data-colors='["--bs-primary", "--bs-success","--bs-danger"]' class="apex-charts"
                    dir="ltr"></div>

                <div class="mt-1 px-2">
                    <div class="order-wid-list d-flex justify-content-between border-bottom">
                        <p class="mb-0"><i class="mdi mdi-square-rounded font-size-10 text-primary me-2"></i>Order
                            Completed</p>
                        <div>
                    ...
                    <div class="order-wid-list d-flex justify-content-between border-bottom">
                        <p class="mb-0"><i class="mdi mdi-square-rounded font-size-10 text-success me-2"></i>Order
                            Processing</p>
                        <div>
                                ...
                                <ol class="activity-checkout mb-0 mt-2 ps-3">
                                        ...
                                        <div class="feed-item-list">
                                            <div class="d-flex">
                                                <div class="flex-grow-1 overflow-hidden me-4">
                                                    <h5 class="font-size-15 mb-1 text-truncate">Have 5 pending order.
                                                    </h5>
                                    ...
                                    <li class="checkout-item crypto-activity">
                                        ...
                                        <div class="feed-item-list">
                                            <div class="d-flex">
                                                <div class="flex-grow-1 overflow-hidden me-4">
                                                    <h5 class="font-size-15 mb-1 text-truncate">Have 1 pending order.
                                                    </h5>
    ...
    <div class="col-xl-5">
        <div class="card">
            <div class="card-body">
                ...
                <div class="slider mt-4 overflow-x-hidden">
                    <!-- Add Pagination -->
                                ...
                                <div class="card dash-product-box shadow-none border mb-0">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-17 mt-1">
                                            <a href="ecommerce-product-detail" class="text-reset lh-base">Stylish
                                                Cricket & Walking Light Weight Shoes</a>
                                        </h5>

                                        <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                class="font-size-17 text-muted fw-normal me-1">$280</del> $140.00</h5>
                                        ...
                                        <div class="mt-4">
                                            <a href="ecommerce-product-detail" class="btn btn-primary btn-sm w-lg"><i
                            ...
                            <div class="swiper-slide">
                                <div class="card dash-product-box shadow-none border mb-0">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-17 mt-1">
                                            <a href="ecommerce-product-detail" class="text-reset lh-base">Combo Pack
                                                of 2 Sports Shoes Running Shoes</a>
                                        </h5>

                                        <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                class="font-size-17 text-muted fw-normal me-1">$320</del> $280.00</h5>
                            ...
                            <div class="swiper-slide">
                                <div class="card dash-product-box shadow-none border mb-0">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-17 mt-1">
                                            <a href="ecommerce-product-detail" class="text-reset lh-base">Trendy Men
                                                Sports Running Running Shoes</a>
                                        </h5>

                                        <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                class="font-size-17 text-muted fw-normal me-1">$740</del> $520.00</h5>
                            ...
                            <div class="swiper-slide">
                                <div class="card dash-product-box shadow-none border mb-0">
                                    <div class="card-body">
                                        ...
                                        <h5 class="font-size-17 mt-1">
                                            <a href="ecommerce-product-detail" class="text-reset lh-base">Sneakers For
                                                Women Sports Running Shoes (Blue)</a>
                                        </h5>

                                        <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                class="font-size-17 text-muted fw-normal me-1">$530</del> $420.00</h5>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{ URL::asset('assets/images/users/avatar-1.jp') }}g"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{ URL::asset('assets/images/users/avatar-2.jp') }}g"
                                                    alt="" class="avatar rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{ URL::asset('assets/images/users/avatar-3.jp') }}g"
                                                    alt="" class="avatar rounded-circle">
                                            </div>
                                    ...
                                    <td>
                                        <p class="mb-0"><i
                                                class="mdi mdi-square-rounded font-size-10 text-danger me-2"></i>Out Of
                                            Stock</p>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{ URL::asset('assets/images/users/avatar-4.jp') }}g"
                                                    alt="" class="avatar rounded-circle">
                                            </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-3">
                                                <img src="{{ URL::asset('assets/images/users/avatar-5.jp') }}g"
                                                    alt="" class="avatar rounded-circle">
                                            </div>
