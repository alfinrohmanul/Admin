                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="avatar">
                                        <span
                                            class="avatar-title bg-primary-subtle text-primary font-size-16 rounded-circle">
                                            M
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="avatar">
                                        <span
                                            class="avatar-title bg-warning-subtle text-warning font-size-16 rounded-circle">
                                            B
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="avatar">
                                        <span
                                            class="avatar-title bg-success-subtle text-success font-size-16 rounded-circle">
                                            K
                                        </span>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="avatar">
                                        <span
                                            class="avatar-title bg-danger-subtle text-danger font-size-16 rounded-circle">
                                            P
                                        </span>
                                    </div>
                                </td>
