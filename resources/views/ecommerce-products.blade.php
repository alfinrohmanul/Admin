    ...
    <div class="col-xl-3 col-lg-4">
        <div class="card">
            ...
            <div class="custom-accordion">
                <div class="p-4 border-top">
                    <div>
                        <h5 class="font-size-15 mb-0"><a href="#filtersizes-collapse" class="text-reset d-block"
                ...
                <div class="p-4 border-top">
                    <div>
                        <h5 class="font-size-15 mb-0"><a href="#filterprodductcolor-collapse" class="text-reset d-block"
                            ...
                            <div class="mt-4">
                                <div class="form-check mt-2">
                                    ...
                                    <label class="form-check-label" for="productcolorCheck1"><i
                                            class="mdi mdi-circle text-reset mx-1"></i> Black</label>
                                </div>
                                <div class="form-check mt-2">
                ...
                <div class="p-4 border-top">
                    <div>
                        <h5 class="font-size-15 mb-0"><a href="#filterproduct-color-collapse"
                                class="text-reset d-block" data-bs-toggle="collapse">Customer Rating <i
                                    class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                ...
                <div class="p-4 border-top">
                    <div>
                        <h5 class="font-size-15 mb-0"><a href="#filterproduct-discount-collapse"
                                class="text-reset d-block" data-bs-toggle="collapse">Discount <i
                                    class="mdi mdi-chevron-up float-end accor-down-icon"></i></a></h5>
                                    ...
                                    <div class="card dash-product-box shadow-none border text-center">
                                        <div class="card-body">
                                            ...
                                            <h5 class="font-size-17 mt-1">
                                                <a href="" class="text-reset lh-base">Stylish Cricket &amp;
                                                    Walking Light Weight Shoes</a>
                                            </h5>

                                            <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                    class="font-size-17 text-muted fw-normal me-1">$280</del> $140.00
                                            </h5>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="card dash-product-box shadow-none border text-center">
                                        <div class="card-body">
                                            ...
                                            <h5 class="font-size-17 mt-1">
                                                <a href="" class="text-reset lh-base">Combo Pack of 2 Sports
                                                    Shoes Running Shoes</a>
                                            </h5>

                                            <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                    class="font-size-17 text-muted fw-normal me-1">$320</del> $280.00
                                            </h5>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="card dash-product-box shadow-none border text-center">
                                        <div class="card-body">
                                            ...
                                            <h5 class="font-size-17 mt-1">
                                                <a href="" class="text-reset lh-base">Trendy Men Sports Running
                                                    Running Shoes</a>
                                            </h5>

                                            <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                    class="font-size-17 text-muted fw-normal me-1">$740</del> $520.00
                                            </h5>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="card dash-product-box shadow-none border text-center">
                                        <div class="card-body">
                                            ...
                                            <h5 class="font-size-17 mt-1">
                                                <a href="" class="text-reset lh-base">Exclusive Sports Running
                                                    Walking Shoes</a>
                                            </h5>

                                            <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                    class="font-size-17 text-muted fw-normal me-1">$420</del> $340.00
                                            </h5>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="card dash-product-box shadow-none border text-center">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                    class="font-size-17 text-muted fw-normal me-1">$240</del> $21.00
                                            </h5>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="card dash-product-box shadow-none border text-center">
                                        <div class="card-body">
                                            ...
                                            <h5 class="font-size-17 mt-1">
                                                <a href="" class="text-reset lh-base">Fire Look Stylish Trendy
                                                    Breathable Lightweight</a>
                                            </h5>

                                            <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                    class="font-size-17 text-muted fw-normal me-1">$620</del> $450.00
                                            </h5>
                                ...
                                <div class="col-xl-4 col-sm-6">
                                    <div class="card dash-product-box shadow-none border text-center">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="font-size-17 mt-1">
                                                <a href="" class="text-reset lh-base">Latest Stylish Casual
                                                    sport shoes for men</a>
                                            </h5>

                                            <h5 class="font-size-20 text-primary mt-3 mb-0"><del
                                                    class="font-size-17 text-muted fw-normal me-1">$520</del> $400.00
                                            </h5>
