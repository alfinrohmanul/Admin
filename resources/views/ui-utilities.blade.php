    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="p-3 mb-2 bg-light text-reset">.bg-light</div>
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="p-3 mb-2 bg-light bg-gradient text-reset">.bg-light .bg-gradient</div>
                ...
                <div class="p-3 bg-transparent bg-gradient text-reset">.bg-transparent .bg-gradient</div>
            </div><!-- end card body -->
        </div><!-- end card -->
    </div><!-- end col -->
</div><!-- end row -->
